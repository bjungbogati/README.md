---
title: "Create Distill Blog in R"
description: |
  This is a tutorial on how you can create a Distill blog in R. Before the end of this article, you'll also learn to build and host your own website/blog using R.
author:
...
## Steps to Create Distill Blog 

You can easily create Distill blog in R using RStudio. 
...
We can easily host our distill blog, once it's available on GitHub repository.
Here, we're going to use Netlify (instead of GitHub Pages). 
...
![](netlify-connect-github.png)
![](netlify-access-distill-blog-repository.png)

![](link-distill-repo-github.png)

- Now you can host your distill blog at Netlify. For that, you need to set 
branch to deploy **master** and publish directory <strong>_site</strong>. 
